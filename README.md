## Welcome to my homelab iac repo

# Install

## Donkey server

packages: terraform, [golang](https://go.dev/doc/install), [kubectl](https://kubernetes.io/docs/tasks/tools/install-kubectl-linux/#install-using-native-package-management), [kustomize](https://kubectl.docs.kubernetes.io/installation/kustomize/binaries/), docker, docker-compose, github agent, helm, [taskfile](https://taskfile.dev/installation/)

resolve issue with domain resolve for server that is not using itself
